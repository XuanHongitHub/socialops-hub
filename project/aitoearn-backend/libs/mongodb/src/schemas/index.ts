...
import { AutomationProfile, AutomationProfileSchema } from './automation-profile.schema'
...
import { ProviderAccount, ProviderAccountSchema } from './provider-account.schema'
...
import { WorkflowRun, WorkflowRunSchema, WorkflowStep, WorkflowStepSchema } from './workflow-run.schema'
...
export * from './automation-profile.schema'
...
export const schemas = [
  ...
  { name: AutomationProfile.name, schema: AutomationProfileSchema },
